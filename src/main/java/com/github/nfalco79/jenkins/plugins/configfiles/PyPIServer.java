...
/**
 * Holder of all informations about a PyPI server.
 * <p>
 * This class keep all necessary information to access a PyPI server that must
 ...
 * @since 1.0
 */
public class PyPIServer extends AbstractDescribableImpl<PyPIServer> implements Serializable {
    ...
    public void doVerify() throws VerifyConfigProviderException {
        ...
        throwException(descriptor.doCheckName(name));
